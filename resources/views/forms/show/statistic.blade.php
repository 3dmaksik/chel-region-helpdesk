...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <p> @if ($data['lead']['day']>0){{ $data['lead']['day'] }} дн. @endif @if ($data['lead']['hour']>0){{ $data['lead']['hour'] }} ч. @endif @if ($data['lead']['minute']>0){{ $data['lead']['minute'] }} мин. @endif @if ($data['lead']['day']=== 0 && $data['lead']['hour'] === 0 && $data['lead']['minute'] === 0) Среднее время ещё невозможно расчитать @endif</p>
