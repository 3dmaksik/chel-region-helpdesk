...
<div class="card mb-4">
    ...
    <div class="card-body">
      <form id="formValidate" method="POST" action="{{ route(config('constants.category.update'),$item->id) }}">
        @method('PATCH')
        <div class="form-group">
            ...
            <input type="text" name="description" value="{{ $item->description }}" class="form-control" id="description" aria-describedby="textHelp" placeholder="Категория" autocomplete="off">
