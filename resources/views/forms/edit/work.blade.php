...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form id="formValidate" method="POST" action="{{ route(config('constants.work.update'),$item->id) }}">
        @method('PATCH')
        @csrf
        <div class="form-group">
            <label for="">Фамилиия</label>
            <input type="text" name="lastname" value="{{ $item->lastname }}" class="form-control @error('lastname') is-invalid @enderror" id="lastname" aria-describedby="textLastname" placeholder="Фамилия" autocomplete="off">
        ...
        <div class="form-group">
            <label for="">Имя</label>
            <input type="text" name="firstname" value="{{ $item->firstname }}" class="form-control @error('firstname') is-invalid @enderror" id="firstname" aria-describedby="textName" placeholder="Имя" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" name="patronymic" value="{{ $item-> patronymic}}" class="form-control @error('patronymic') is-invalid @enderror" id="patronymic" aria-describedby="textPatronymic" placeholder="Отчество" autocomplete="off">
