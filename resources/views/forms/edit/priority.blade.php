...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form id="formValidate" method="POST" action="{{ route(config('constants.priority.update'),$item->id) }}">
        @method('PATCH')
        @csrf
        <div class="form-group">
            <label for="">Название</label>
            <input type="text" name="description" value="{{ $item->description }}" class="form-control @error('description') is-invalid @enderror" id="description" aria-describedby="textHelp" placeholder="Средний" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" name="rang" value="{{ $item->rang }}" class="form-control @error('rang') is-invalid @enderror" id="rang" aria-describedby="textRang" placeholder="3" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" name="warning_timer" value="{{ $item->warning_timer}}" class="form-control @error('warning_timer') is-invalid @enderror" id="warning-timer" aria-describedby="textWarningTimer" placeholder="1" autocomplete="off">
        ...
        <div class="form-group">
            <label for="">Время</label>
            <input type="text" name="danger_timer" value="{{ $item->danger_timer }}" class="form-control @error('danger_timer') is-invalid @enderror" id="danger-timer" aria-describedby="textDangerTimer" placeholder="2" autocomplete="off">
