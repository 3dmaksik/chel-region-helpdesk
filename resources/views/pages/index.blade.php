...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
	...
	<nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="" data-toggle="modal" data-target="#login">Войти</a></li>
        </ul>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      ...
      <h2>Войдите по логину и паролю, чтобы оставить заявку, либо нажмите кнопку ниже, если ваш компьютер недоступен</h2>
    ...
    <section id="get-form" class="padd-section">
        <div class="container" data-aos="fade-up">
            <div class="section-title text-center">
              <h2>Новая Заявка</h2>
              <p class="separator">Внимательно заполните все поля и правильно выберите ФИО во избежание ошибок.</p>
            </div>
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
              <div class="col-lg-8 col-md-6">
                <div class="form">
                  <form name="form" id="formValidate" enctype="multipart/form-data" method="POST" action="{{ route('index.store') }}" role="form" class="php-email-form">
                    @csrf
        <div class="form-group">
            <label for="select2-category">Выберите категорию</label>
            <select class="select2-single form-control" data-aos-delay="100" name="category_id" id="select2-category">
        ...
        <div class="form-group">
            ...
            <select class="select2-single form-control" data-val="true" name="user_id" id="select2-user">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="select2-description-long" rows="3" name="description_long"></textarea>
        </div>
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                <input type="file" name="images[]" class="custom-file-input" id="customFile" accept="image/png, image/jpeg" multiple />
                    ...
                    <div class="text-center"><input class="btn-get-started" type="submit" value="Отправить" /></div>
                  </form>
                </div>
              </div>
            </div>
  ...
  <a href="#header" class="back-to-top scrollto d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
          ...
          <form class="user" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                <input type="text" name="name" class="form-control" id="description" required autocomplete="name" placeholder="Введите логин" autocomplete="off">
            </div>
            <div class="form-group">
