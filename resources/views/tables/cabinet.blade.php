...
<div class="card">
	<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <a href="{{ route(config($generateNames.'.create')) }}"> <button type="button" class="btn btn-primary mb-1">Новый кабинет </button></a>
	</div>
			...
			<tbody id="table-dynamic">
				...
				<tr>
					...
					<td class="d-print-none">
                     ...
                     <form method="POST" style="display: inline" action="{{ route(config($generateNames.'.destroy'),$item->id) }}">
                        <div class="block">
                                @method('DELETE')
                                @csrf
