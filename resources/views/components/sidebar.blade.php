...
<ul class="navbar-nav sidebar sidebar-light accordion d-print-none" id="accordionSidebar">
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route(config('constants.news.index')) }}">
		<div class="sidebar-brand-icon"> <img src="/img/logo/logo2.png"> </div>
		<div class="sidebar-brand-text mx-3">Главные заявки</div>
	</a>
	<hr class="sidebar-divider my-0">
    <li id="newsSidebar">
        <li class="nav-item {{ request()->segment(1) == 'news' ? 'active':'' }}"> <a class="nav-link" href="{{ route(config('constants.news.index')) }}">
    ...
    <li id="workSidebar" class="nav-item ">
        ...
        <div id="WorkForm" class="collapse {{ request()->segment(1) == 'admin' && request()->segment(2) == 'helps' ? 'show':'' }}" aria-labelledby="headingForm" data-parent="#workSidebar" style="">
      ...
      <li id="UserSidebar" class="nav-item">
        ...
        <div id="UserForm" class="collapse {{ request()->segment(1) == 'home' && request()->segment(2) == 'helps' ? 'show':'' }}" aria-labelledby="headingForm" data-parent="#UserSidebar" style="">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Мои заявки</h6>
            <a class="collapse-item {{ request()->segment(1) == 'home' && request()->segment(3) == 'worker' ? 'active':'' }}" href="{{ route(config('constants.home.worker')) }}">В работе</a>
            <a class="collapse-item {{ request()->segment(1) == 'home' && request()->segment(3) == 'completed' ? 'active':'' }}" href="{{ route(config('constants.home.completed')) }}">Выполненные</a>
            <a class="collapse-item {{ request()->segment(1) == 'home' && request()->segment(3) == 'dismiss' ? 'active':'' }}" href="{{ route(config('constants.home.dismiss')) }}">Отклонённые</a>
        </div>
        </div>
      </li>
	<hr class="sidebar-divider">
   ...
   <li class="nav-item {{ request()->segment(1) == 'admin' && request()->segment(2) == 'priority' ? 'active':'' }}"> <a class="nav-link" href="{{ route(config('constants.priority.index')) }}">
	...
	<li class="nav-item {{ request()->segment(1) == 'stats' ? 'active':'' }}"> <a class="nav-link" href="{{ route('stats') }}">
            <i class="fas fa-fw fa-star"></i>
