...
mkdir /var/www/html/chel-region-helpdesk/storage/images && mkdir /var/www/html/chel-region-helpdesk/storage/avatar && mkdir /var/www/html/chel-region-helpdesk/storage/sound && mkdir /var/www/html/chel-region-helpdesk/storage/files
...
sudo docker compose exec app ln -s ./app/public/files ./storage/files
