...
class DismissHelpNotification extends Notification implements ShouldBroadcast
{
    public Model $model;
    ...
    public function toBroadcast($notifiable): BroadcastMessage
    {
        return new BroadcastMessage([
            ...
            'calendarExecution' => 'Дата неопределена',
            'calendarFinal' => date('d.m.Y H:i', strtotime($this->model->calendar_final)),
            'status' => 'dismiss',
        ]);
    }
}
